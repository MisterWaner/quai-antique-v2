            ...
            {(toggleMenu || screenWidth > 768) && (
                <ul className="flex flex-col items-center py-5 space-y-5 z-[3] list-none backdrop-blur-sm border border-b-black md:flex-row md:space-y-0 md:py-0 md:justify-around ">
                    ...
                    <li
                        ...
                        className="font-pynion text-3xl md:text-2xl lg:text-3xl font-bold"
                    >
                        <Link to="/a-propos" className="no-underline text-white text-shadow hover:underline hover:decoration-2 hover:underline-offset-4">
                            À propos
                        </Link>
                    </li>
                    <li
                        ...
                        className="font-pynion text-3xl md:text-2xl lg:text-3xl font-bold"
                    >
                        <Link to="/contact" className="no-underline text-white text-shadow hover:underline hover:decoration-2 hover:underline-offset-4">
                            Contact
                        </Link>
                    </li>
                    <li
